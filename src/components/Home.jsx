...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#f5f7f9] font-sans text-[#15202b] flex flex-col">
      ...
      <main className="text-white py-12 px-6 m-6 md:m-10 rounded-2xl lg:px-24 flex items-center justify-center relative overflow-hidden shadow-lg">
        
        {/* 1. The Fixed Background Image Layer */}
        {/* Replace '/your-hero-background.jpg' with your actual image path */}
        <div 
        ...
        {/* This applies the original dark blue background with 85% opacity so the image peeks through */}
        <div className="absolute inset-0 bg-[#0c2230] opacity-85 z-0"></div>

        {/* Abstract Background Elements (Kept intact, sitting above the overlay) */}
        ...
        {/* z-20 ensures the text and form sit completely above the backgrounds and abstract shapes */}
        <div className="max-w-7xl w-full grid grid-cols-1 lg:grid-cols-2 gap-12 relative z-20">
          {/* Left Column - Information */}
          <div className="flex flex-col justify-center max-w-lg">
            <h2 className="text-4xl font-bold mb-6 leading-tight drop-shadow-sm">
          ...
          <div className="flex justify-end">
            <div className="w-full max-w-md border border-[#304a5e] bg-transparent rounded-xl p-8 backdrop-blur-sm shadow-xl">
              ...
              <form className="space-y-4">
                <div>
                  ...
                  <input
                    type="text"
                    className="w-full bg-black/20 border border-[#304a5e] rounded-md px-3 py-2 text-white focus:outline-none focus:border-[#4ca1cf]"
                  />
                </div>
                ...
                <div className="pt-2">
                  <button
                    type="button"
                    className="bg-[#165d83] hover:bg-[#124b69] text-white px-6 py-2 rounded-md text-sm font-medium transition-colors w-full md:w-auto"
                  >
                    Log in
                  </button>
                </div>
      ...
      <section className="relative py-32 mb-27 px-6 text-center flex flex-col items-center justify-center overflow-hidden">
